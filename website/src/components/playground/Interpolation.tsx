...
const NumberInterpolation: React.FC<{
...
export const SelectInterploation: React.FC<{
  node: Exclude<AstNode, string>;
  value: any;
...
const DateInterpolation: React.FC<{
  node: Exclude<AstNode, string>;
  value: Date;
...
const TimeInterpolation: React.FC<{
  node: Exclude<AstNode, string>;
  value: Date;
  onChange: (value: Date) => void;
}> = ({ node, value, onChange }) => {
...
export const MappingDisplay: React.FC<{
  node: Exclude<AstNode, string>;
}> = ({ node }) => {
  if (node.type !== 'external') return null;
